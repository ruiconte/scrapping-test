...
OUTREACH_BROWSER_PROFILE_DIR = BASE_DIR / "browser_profile_outreach"
...
for _d in (DATA_DIR, EXPORTS_DIR, LOGS_DIR, BROWSER_PROFILE_DIR, OUTREACH_BROWSER_PROFILE_DIR, PROSPECTS_EXPORT_DIR):
